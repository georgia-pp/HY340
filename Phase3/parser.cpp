...
{
       0,   146,   146,   149,   150,   153,   161,   162,   163,   164,
     165,   172,   179,   180,   181,   184,   187,   207,   227,   246,
     265,   284,   296,   316,   337,   349,   349,   373,   373,   388,
     388,   410,   410,   430,   433,   435,   437,   441,   456,   469,
     488,   488,   508,   527,   527,   547,   550,   550,   573,   574,
     575,   576,   580,   583,   611,   634,   640,   641,   644,   648,
     648,   657,   657,   688,   701,   704,   704,   712,   712,   712,
     724,   724,   746,   746,   762,   763,   766,   766,   771,   771,
     776,   776,   780,   783,   783,   787,   790,   793,   796,   797,
     800,   800,   800,   806,   806,   828,   846,   862,   862,   875,
     889,   890,   892,   896,   900,   904,   908,   912,   917,   917,
     918,   921,   921,   922,   925,   931,   938,   938,   945,   951,
     970,   976,   976,   985,   985,  1007,  1007,  1007,  1020,  1020,
    1020,  1027
};
#endif
...
#line 172 "parser.y"
                             {cout << "CONTINUE SEMICOLON -> stmt"<<endl;
...
#line 1831 "parser.cpp"
  ...
  case 33: /* expr: term  */
#line 430 "parser.y"
               {cout << "term -> expr"<< endl; (yyval.exprNode2) = (yyvsp[0].exprNode2);}
...
#line 437 "parser.y"
                                                {cout << "LEFT_PARENTHESIS expr RIGHT_PARENTHESIS -> term"<<endl; 
...
#line 441 "parser.y"
                           {cout << "SUBTRACTION expr -> term"<<endl;
...
#line 469 "parser.y"
                         {cout << "PLUSONE lvalue -> term"<<endl; /*if( $2 != NULL) {if($2->sym->type == LIB_FUNCTION || $2->sym->type == USERFUNCTION) symbolTable->errors.push_back("ERROR in line "+to_string(yylineno)+": "+$2->sym->name+" is declared as a function, forbidden action ++");} */
            if (!checkarithmetic_type((yyvsp[0].exprNode2),(yyvsp[0].exprNode2))) symbolTable->errors.push_back("RUNTIME ERROR in line "+to_string(yylineno)+": invalid arithmetic expression");
...
#line 1920 "parser.cpp"
  ...
  case 40: /* $@5: %empty  */
#line 488 "parser.y"
                 {if( (yyvsp[0].exprNode2) != NULL) { cout << "lvalue PLUSONE -> term"<<endl; /*if($1->sym->type == LIB_FUNCTION || $1->sym->type == USERFUNCTION) symbolTable->errors.push_back("ERROR in line "+to_string(yylineno)+": "+$1->sym->name+" is declared as a function, forbidden action ++");*/} }
...
#line 508 "parser.y"
                          {if( (yyvsp[0].exprNode2) != NULL) { cout << "MINUSONE lvalue -> term"<<endl; /*if($2->sym->type == LIB_FUNCTION || $2->sym->type == USERFUNCTION) symbolTable->errors.push_back("ERROR in line "+to_string(yylineno)+": "+$2->sym->name+" is declared as a function, forbidden action --");*/} 
            if (!checkarithmetic_type((yyvsp[0].exprNode2),(yyvsp[0].exprNode2))) symbolTable->errors.push_back("RUNTIME ERROR in line "+to_string(yylineno)+": invalid arithmetic expression");
...
#line 1975 "parser.cpp"
  ...
  case 43: /* $@6: %empty  */
#line 527 "parser.y"
                 {if( (yyvsp[0].exprNode2) != NULL) { cout << "lvalue MINUSONE -> term"<<endl; /*if($1->sym->type == LIB_FUNCTION || $1->sym->type == USERFUNCTION) symbolTable->errors.push_back("ERROR in line "+to_string(yylineno)+": "+$1->sym->name+" is declared as a function, forbidden action --");*/} }
...
#line 547 "parser.y"
                  { cout << "primary -> term" <<endl; (yyval.exprNode2) = (yyvsp[0].exprNode2);}
...
#line 550 "parser.y"
                                                                                                                                                                                                                                                               { cout << "lvalue EQUAL expr -> assignexpr"<<endl;   
...
#line 573 "parser.y"
                   {cout << "lvalue -> primary"<<endl; (yyval.exprNode2) = emit_iftableitem((yyvsp[0].exprNode2));}
...
#line 575 "parser.y"
                        {cout << "objectdef -> primary"<<endl;}
#line 2062 "parser.cpp"
    break;

  case 51: /* primary: LEFT_PARENTHESIS funcdef RIGHT_PARENTHESIS  */
#line 576 "parser.y"
                                                         {cout << "LEFT_PARENTHESIS funcdef RIGHT_PARENTHESIS -> primary" <<endl; 
...
#line 580 "parser.y"
                    {cout << "const -> primary" <<endl; (yyval.exprNode2) = (yyvsp[0].exprNode2);}
...
#line 634 "parser.y"
                             { cout << "DOUBLECOLON ID -> lvalue"<<endl;

                if(! ((yyval.exprNode2) = lvalue_expr(symbolTable->lookUp((yyvsp[0].stringValue), 0)))){
...
#line 640 "parser.y"
                     { cout << "member -> lvalue"<<endl; }
#line 2155 "parser.cpp"
    break;

  case 57: /* lvalue: tableitem  */
#line 641 "parser.y"
                        { cout << "tableitem -> lvalue"<<endl; (yyval.exprNode2) = (yyvsp[0].exprNode2);}
...
#line 704 "parser.y"
                                                                                                                        { cout << "call LEFT_BRACKET expr RIGHT_BRACKET -> member"<<endl;
                (yyvsp[-4].exprNode2) = emit_iftableitem((yyvsp[-4].exprNode2));
                (yyval.exprNode2) = newexpr(tableitem_e);
                (yyval.exprNode2)->sym = (yyvsp[-4].exprNode2)->sym;
                (yyval.exprNode2)->index = (yyvsp[-2].exprNode2);
...
#line 712 "parser.y"
                                                                                                    { cout << "call LEFT_PARENTHESIS elist RIGHT_PARENTHESIS -> call" << endl; functionCall = 0;
...
#line 724 "parser.y"
                                                    {cout << "lvalue callsuffix -> call"<<endl;
              ...
              expr* e = newexpr((yyvsp[-2].exprNode2)->type);
              e->sym = newtemp();
              (yyval.exprNode2) = e;
...
#line 746 "parser.y"
                                                                                                                                          {
               cout << "LEFT_PARENTHESIS funcdef RIGHT_PARENTHESIS LEFT_PARENTHESIS elist RIGHT_PARENTHESIS -> call"<<endl;
...
#line 762 "parser.y"
                     { cout << "normvall -> callsuffix" <<endl;}
#line 2364 "parser.cpp"
    break;

  case 75: /* callsuffix: methodcall  */
#line 763 "parser.y"
                         {cout << "methodcall -> callsuffix" <<endl; doubleDotEncountered = true; (yyval.stringValue)  = (yyvsp[0].stringValue); }
...
#line 766 "parser.y"
                                                                          {cout << "LEFT_PARENTHESIS elist RIGHT_PARENTHESIS -> normcall" <<endl;
...
#line 771 "parser.y"
                                                                                        {cout << "DOUBLEDOT ID LEFT_PARENTHESIS elist RIGHT_PARENTHESIS -> methodcall"<<endl;
...
#line 2413 "parser.cpp"
  ...
  case 82: /* elist: %empty  */
#line 780 "parser.y"
                        {cout << "empty -> elist"<<endl; (yyval.exprNode2) = NULL; }
...
#line 783 "parser.y"
                                                                                                   { cout << "COMMA expr exprs -> exprs"<<endl;
                tableitems.insert(tableitems.begin(), (yyvsp[-2].exprNode2));
...
#line 793 "parser.y"
                                     {cout << "indexedelem indexedelems -> indexed"<<endl;}
#line 2446 "parser.cpp"
    break;

  case 88: /* indexedelems: COMMA indexedelem indexedelems  */
#line 796 "parser.y"
                                               {cout << "COMMA indexedelem indexedelems -> indexedelems"<<endl;}
#line 2452 "parser.cpp"
    break;

  case 89: /* indexedelems: %empty  */
#line 797 "parser.y"
                            {cout << "empty -> indexedelems" <<endl;}
...
#line 800 "parser.y"
                                                                                                                                                                                                                   {cout << "LEFT_CURLY_BRACKET expr COLON expr RIGHT_CURLY_BRACKET -> indexedelem"<<endl;                    
...
#line 917 "parser.y"
                                                                                                                                                                                                                                 {cout <<"ID ids -> idlist"<<endl;}
#line 2667 "parser.cpp"
    break;

  case 110: /* idlist: %empty  */
#line 918 "parser.y"
                            {cout <<"empty -> idlist"<<endl;}
